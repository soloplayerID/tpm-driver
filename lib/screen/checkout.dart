...
import 'package:TPMDriver/screen/fragment/tagihan/pembayaran_bayar.dart';
...
import 'package:TPMDriver/src/presenter/pembayaran.dart';
import 'package:TPMDriver/src/presenter/total_nilai.dart';
import 'package:TPMDriver/src/state/bayar.dart';
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (selected == null) {
                          Toast.show("bank harus dipilih", context,

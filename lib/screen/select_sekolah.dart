...
import 'package:TPMDriver/screen/fragment/selectprovinsi.dart';
import 'package:TPMDriver/screen/fragment/selectsekolah.dart';
import 'package:TPMDriver/screen/fragment/widget/clipath.dart';
import 'package:TPMDriver/screen/tryout.dart';
import 'package:TPMDriver/src/model/pilih_sekolah.dart';
import 'package:TPMDriver/src/presenter/select_sekolah.dart';
import 'package:TPMDriver/src/state/pilih_sekolah.dart';
                        ...
                        child: TextFormField(
                          ...
                          onTap: (() => {
                                this._selectSekolahModel.idProv == 0
                                    ? Toast.show(
                                        "Provinsi Harus Dipilih", context,
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            this._selectSekolahModel.sekolahId == 0
                                ? Toast.show("Sekolah Harus Dipilih", context,
                                    duration: Toast.LENGTH_SHORT,
                                    gravity: Toast.BOTTOM)
                                : Navigator.push(
                                    context,
